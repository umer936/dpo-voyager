...
// Add Newbutton tab enum
enum EHelpSection { Nav, Menu, Newbutton = 2 }
...
export default class HelpMain extends Popup
{
    ...
    protected render()
    {
        ...
        const NewbuttonContent = html`<div class="sv-help-text">This is an example of a new button with new instructions/directions.</div>
                                <div class="sv-help-row">
                                    <div class="sv-help-section sv-help-short">
                                    ...
                                    <div class="sv-help-section sv-help-short">
                                        <ff-icon class="ff-off" name="share"></ff-icon>
                                        <div class="sv-help-text">Polyline! Shaders!</div>
                                    </div>
                                    <div class="sv-help-section sv-help-short">
        ...
        <div class="sv-help-region" role="region" aria-label="Introduction to Voyager" @keydown=${e =>this.onKeyDownMain(e)}>
            ...
            <div class="sv-commands" style="display: flex; flex-wrap: nowrap;">
                ...
                <ff-button text="New Tools!" index=${EHelpSection.Newbutton} selectedIndex=${section} @click=${this.onClickSection}></ff-button>
            </div>
            ${section === EHelpSection.Nav ? navContent : section === EHelpSection.Menu ? menuContent : NewbuttonContent}
        </div>
        `;
    }
